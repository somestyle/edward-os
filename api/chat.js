...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Gemini 3.1 Flash-Lite (preview) requires the first message in 'contents' to be from the 'user'
    ...
    if (!response.ok) {
      console.error('Gemini 3.1 Flash-Lite API Error:', JSON.stringify(data, null, 2));
